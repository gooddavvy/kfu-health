  ...
  getProfileInfo()
    .then((profileInfo) => {
      profileInfo.goals.push({
        type: "Pull-up Training",
        startDate: new Date().toLocaleDateString(),
        deadline: thisDeadline,
        initialMaxPullups: cmp,
        targetMaxPullups: thisMax,
        currentMaxPullups: cmp,
    ...
    <div>
      <Modal open={open} onClose={handleClose}>
        ...
        >
          ...
          <TextField
            label="Target maximum pull-up value"
            variant="outlined"
            fullWidth
            value={max}
